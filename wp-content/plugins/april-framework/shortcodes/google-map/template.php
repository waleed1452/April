 ...
 */
$el_class = $map_height = $map_height_lg = $map_height_md = $map_height_sm = $map_height_mb = $api_key = $map_zoom = $scroll_wheel = $map_style = $map_style_content = $markers =
...
if(empty($map_height)) $map_height = '500px';
$map_css = <<<CSS
    .{$map_class} {
        height: {$map_height};
    }
