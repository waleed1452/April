			...
			foreach ($custom_tax as $tax => $args) {
				...
				$default = array(
					...
					'labels'       => array(
						...
						'menu_name'                  => $label,
						'search_items'               => sprintf(esc_html__('Search %s', 'april-framework'), $label),
						'popular_items'              => sprintf(esc_html__('Popular %s', 'april-framework'), $label),
						'all_items'                  => sprintf(esc_html__('All %s', 'april-framework'), $label),
						'parent_item'                => sprintf(esc_html__('Parent %s', 'april-framework'), $singular_name),
						'parent_item_colon'          => sprintf(esc_html__('Parent %s:', 'april-framework'), $singular_name),
						'edit_item'                  => sprintf(esc_html__('Edit %s', 'april-framework'), $singular_name),
						'view_item'                  => sprintf(esc_html__('View %s', 'april-framework'), $singular_name),
						'update_item'                => sprintf(esc_html__('Update %s', 'april-framework'), $singular_name),
						'add_new_item'               => sprintf(esc_html__('Add New %s', 'april-framework'), $singular_name),
						'new_item_name'              => sprintf(esc_html__('New %s New', 'april-framework'), $singular_name),
						'separate_items_with_commas' => sprintf(esc_html__('Separate %s with commas', 'april-framework'), strtolower($label)),
						'add_or_remove_items'        => sprintf(esc_html__('Add or remove %s', 'april-framework'), strtolower($label)),
						'choose_from_most_used'      => sprintf(esc_html__('Choose from the most used %s', 'april-framework'), strtolower($label)),
						'not_found'                  => sprintf(esc_html__('No %s found.', 'april-framework'), strtolower($label)),
						'no_terms'                   => sprintf(esc_html__('No %s', 'april-framework'), strtolower($label)),
						'items_list_navigation'      => sprintf(esc_html__('%s list navigation', 'april-framework'), $label),
						'items_list'                 => sprintf(esc_html__('%s list', 'april-framework'), $label),
					)
				);
