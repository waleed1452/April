		...
		public function registerScript() {
			...
			if ( version_compare($wp_version,'5.5') >= 0) {
				wp_localize_script('wp-color-picker-alpha',
					'wpColorPickerL10n',
					array(
						'clear'            => esc_html__( 'Clear','april-framework' ),
						'clearAriaLabel'   => esc_html__( 'Clear color','april-framework'  ),
						'defaultString'    => esc_html__( 'Default','april-framework'  ),
						'defaultAriaLabel' => esc_html__( 'Select default color','april-framework'  ),
						'pick'             => esc_html__( 'Select Color','april-framework'  ),
						'defaultLabel'     => esc_html__( 'Color value','april-framework'  ),
					));
			}
