				...
				if (is_array($xmenu_meta)) {
					if (isset($xmenu_meta['menu-item-featured-style']) && ($xmenu_meta['menu-item-featured-style'] != '')) {
						...
						switch ($xmenu_meta['menu-item-featured-style']) {
							case 'hot': {
								$menu_featured_text = esc_html__('Hot','april-framework');
								break;
							}
							case 'new': {
								$menu_featured_text = esc_html__('New','april-framework');
								break;
							}
							default: {
								$menu_featured_text = esc_html__('Featured','april-framework');
							}
						}
